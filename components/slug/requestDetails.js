    ...
    <div className="w-1/3 flex-1 px-6 bg-white py-4  rounded-xl h-[800px]">
      {rfqData!=null && <div>
        ...
        <div className="flex  space-x-16  items-center py-4">
          ...
          <p className={`${rfqData.rfqScore < 68 ?  "text-rose-600": "text-green-600" } font-bold text-2xl`}>{rfqData.rfqScore}</p>
        </div>
        <p className="font-semibold text-xl text-gray-800 ">Request Details</p>
